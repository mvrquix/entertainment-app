...
import { VIEW_HOME, VIEW_MOVIES, VIEW_TV, VIEW_BOOKMARKS } from '../views'
...
const EntertainmentUI = (props) => {
	...
	const handleBookmark = (item) => {
		...
		if (!isBookmarked) setBookmarks([...bookmarks, item])
		else setBookmarks(bookmarks.filter((x) => x.title === item.title))
	}
